...
public class MyList<E> implements Cloneable, Iterable<E> {
	...
	/**
	 * Da die Liste waehrend des Durchlaufens mit einem Iterator nicht 
	 * veraendert werden darf (fail fast iterator), wird in aenderungenListe
	 * die Zahl der Aenderungen an der Liste festgehalten.
	 */
	...
	/**
	 * Gibt die aktuelle Zahl der Aenderungen an der urspruenglichen
	 * Liste zurueck
	 * 
	 * @return aktuelle Zahl der Veraenderungen
	 */
	public int getAenderungenListe() {
		return this.aenderungenListe;
	}
	
	/**
	 * erhoeht die Variabel, in der die Zahl der Veraenderungen an der Liste
	 * gespeichert ist
	 */
	public void erhoeheAenderungenListe() {
		this.aenderungenListe++;
	}
	...
	public Iterator<E> iterator() {
		...
		return new ListeIterator<E>(this, this.begin);
	}
