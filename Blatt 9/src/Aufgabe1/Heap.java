...
private static final int DEFAULT_INITIAL_CAPACITY = 11;
   ...
   /**
    * Writes object into a file with an OOS
    * If there is an null object it will be skipped.
    * 
    * @param os
    * @throws IOException
    */
   ...
   /**
    * Reads an object from a file with an OIS
    * 
    * @param is
   ...
   private void readObject(ObjectInputStream is) throws ClassNotFoundException, IOException {
	   ...
	   this.heap = new Object[this.size()];
	   
	   for(int i = 0; i< this.size(); i++) {
		   this.heap[i] = is.readObject();
	   }
   }
