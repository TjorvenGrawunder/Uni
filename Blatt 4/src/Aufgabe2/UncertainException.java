...
public class UncertainException {
   ...
   /**
    * Durch eine finally kann return i++; nie erreicht werden. Die for-Schleife bricht zwar mit break ab, jedoch wird danach direkt
    * finally ausgefuehrt und eine Exception ausgeworfen, wodurch die Methode abgebrochen wird.
    * @return
    */
